...
<body class="bg-white text-gray-800">
  ...
  <section class="my-4 mx-4 p-4 text-center rounded-lg bg-green-500 text-white">
    <div class="ml-8">
      ...
      <p class="mt-2 text-xl">Anda berada pada tingkat stres yang rendah. Tingkat stres yang rendah menunjukkan bahwa
        Anda menangani tantangan hidup secara efektif dan menjaga keseimbangan yang sehat. Keadaan ini memungkinkan Anda
      ...
      <p class="mt-1 text-lg font-kanit">4. Luangkan waktu untuk melakukan hal-hal yang Anda nikmati dan memberikan Anda
        kebahagiaan.</p>
